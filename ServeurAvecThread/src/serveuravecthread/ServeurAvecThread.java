 ...
 * @author Asus R511L
 */
public class ServeurAvecThread extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        new ServeurAvecThread().setVisible(true);
        
    }
    
    public ServeurAvecThread() {
        fenetre();
    }
    ...
    private void serveur() {
        try {
            ...
            // Lancement du thread pour l'attente des clients
            // On peut pas le faire ici car le code serveur.accept() est bloquant
            // et cela fige l'interface
            new Thread(() -> {
                try {
                    while (true) {
                        Socket socket = serveur.accept();
                        
                        // Démarrage du thread pour la prise en compte du transfert
                        thread++;
                        Client client = new Client(socket, thread);
    ...
    private void fenetre() {
        ...
        setTitle("RECEPTION DE FICHIERS : Serveur avec thread");
        setResizable(false);
        ...
        jTextContenu.getAccessibleContext().setAccessibleName("contenu");
        ...
        jLabQuestion.setText("Serveur avec thread");
    ...
    class Client implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                jTextContenu.append("Démarrage du thread " + numero + " ...\n");
                jTextContenu.append("Thread " + thread + " demarré\n\n");

                jTextContenu.append("Réception du fichier en cours ...\n");
                ...
                jTextContenu.append("***********************Thread " + numero+"***********************\n\n");
                jTextContenu.append("Reception du fichier terminée avec une taille de " + bits + " bytes.\n");
                jTextContenu.append("Affichage du contenu du fichier :\n");
                ...
                jTextContenu.append(e.toString());
            } 
            catch (IOException e) {
                jTextContenu.append(e.toString());
            } finally {
